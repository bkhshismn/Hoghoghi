...
namespace Hoghoghi
{
    public partial class frmMakhtome : Form
    {
        public frmMakhtome()
        {
            InitializeComponent();
        ...
        void DisplayParvande()
        {
            ...
            adb.SelectCommand.CommandText = "select * from View_UserToParvandeToMakhtome where UserID=" + UserID + "and Vaziat=" + 0 + " ORDER BY ParvandeID desc";
            adb.Fill(ds, "View_UserToParvandeToMakhtome");
            dgvParvande.DataSource = ds;
            dgvParvande.DataMember = "View_UserToParvandeToMakhtome";
        ...
        void DisplayParvande(int y)
        {
            ...
            adb.SelectCommand = new SqlCommand();
            adb.SelectCommand.Connection = con;
            adb.SelectCommand.CommandText = "select * from View_UserToParvandeToMakhtome where (UserID=" + UserID + " or Years=" + y + ") and Vaziat=" + 0 + " ORDER BY ParvandeID desc";
            adb.Fill(ds, "View_UserToParvandeToMakhtome");
            dgvParvande.DataSource = ds;
            dgvParvande.DataMember = "View_UserToParvandeToMakhtome";
            dgvParvande.Columns["UserID"].Visible = false;
            ...
            dgvParvande.Columns["Years"].Visible = false;
            dgvParvande.Columns["Month"].Visible = false;
            dgvParvande.Columns["NoMakhtome"].HeaderText = "نوع مختومه";
            dgvParvande.Columns["DateMakhtome"].HeaderText = "تاریخ مختومه ";
            dgvParvande.Columns["ParvandeID"].HeaderText = "شماره پرونده";
            dgvParvande.Columns["BankName"].HeaderText = "نام بانک";
            dgvParvande.Columns["BankName"].Width = 100;
            dgvParvande.Columns["Shobe"].HeaderText = "شعبه";
            ...
            dgvParvande.Columns["DateSabt"].Width = 70;
            dgvParvande.Columns["Komision"].HeaderText = "کمیسیون";
            dgvParvande.Columns["Expr1"].HeaderText = "نام کاربر";
        ...
        private void frmMakhtome_Load(object sender, EventArgs e)
        {
        ...
        private void cmbBankNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                adp.SelectCommand.CommandText = "select * from View_UserToParvandeToMakhtome where  BankName Like '%' + @BankName + '%'and Years =" + int.Parse(txtDate.Text) + " and Vaziat=" + 0 + "";
                adp.SelectCommand.Parameters.AddWithValue("@BankName", cmbBankNo.Text + "%");
                adp.Fill(ds, "View_UserToParvandeToMakhtome");
                dgvParvande.DataSource = ds;
                dgvParvande.DataMember = "View_UserToParvandeToMakhtome";
                ...
                dgvParvande.Columns["ShTashilat"].HeaderText = "شماره تسهیلات";
                dgvParvande.Columns["ShTashilat"].Width = 80;
                dgvParvande.Columns["Date"].HeaderText = "تاریخ سررسید ";
                dgvParvande.Columns["Date"].Width = 70;
                dgvParvande.Columns["Bed"].HeaderText = "مبلغ بدهی";
                dgvParvande.Columns["Bed"].Width = 100;
                dgvParvande.Columns["Address"].HeaderText = "آدرس";
        ...
        private void txtName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                adp.SelectCommand = new SqlCommand();
                adp.SelectCommand.Connection = con;
                adp.SelectCommand.CommandText = "select * from View_UserToParvandeToMakhtome where  Name Like '%' + @Name + '%'  and  Years =" + int.Parse(txtDate.Text) + " and Vaziat=" + 0 + "";
        ...
        private void txtMelli_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                adp.SelectCommand = new SqlCommand();
                adp.SelectCommand.Connection = con;
                adp.SelectCommand.CommandText = "select * from View_UserToParvandeToMakhtome where  Melli Like '%' + @Melli + '%' and  Years =" + int.Parse(txtDate.Text) + " and Vaziat=" + 0 + "";
        ...
        private void txtShTashilat_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                adp.SelectCommand = new SqlCommand();
                adp.SelectCommand.Connection = con;
                adp.SelectCommand.CommandText = "select * from View_UserToParvandeToMakhtome where  ShTashilat Like '%' + @ShTashilat + '%'  and  Years =" + int.Parse(txtDate.Text) + "and Vaziat=" + 1 + "";
        ...
        private void buttonX4_Click(object sender, EventArgs e)
        {
            try
            {
                if (Sath == 1)
                {
                    ...
                    adp.SelectCommand = new SqlCommand();
                    adp.SelectCommand.Connection = con;
                    adp.SelectCommand.CommandText = "select * from View_UserToParvandeToMakhtome where  Name Like '%' + @Name + '%' and BankName Like '%' + @BankName + '%'and Melli Like '%' + @Melli + '%' and  ShTashilat Like '%' + @ShTashilat + '%' and (UserID=" + UserID + " or  Years =" + int.Parse(txtDate.Text) + ") and Vaziat=" + 0 + "";
                    adp.SelectCommand.Parameters.AddWithValue("@Name", txtName.Text + "%");
                    adp.SelectCommand.Parameters.AddWithValue("@BankName", cmbBankNo.Text + "%");
                    adp.SelectCommand.Parameters.AddWithValue("@Melli", txtMelli.Text + "%");
                    adp.SelectCommand.Parameters.AddWithValue("@ShTashilat", txtShTashilat.Text + "%");
                ...
                else
                {
                    ...
                    adp.SelectCommand = new SqlCommand();
                    adp.SelectCommand.Connection = con;
                    adp.SelectCommand.CommandText = "select * from View_UserToParvandeToMakhtome where  Name Like '%' + @Name + '%' and BankName Like '%' + @BankName + '%'and Melli Like '%' + @Melli + '%' and  ShTashilat Like '%' + @ShTashilat + '%' and UserID=" + UserID + " and  Years =" + int.Parse(txtDate.Text) + " and Vaziat=" + 0 + "";
                    adp.SelectCommand.Parameters.AddWithValue("@Name", txtName.Text + "%");
                    adp.SelectCommand.Parameters.AddWithValue("@BankName", cmbBankNo.Text + "%");
                    adp.SelectCommand.Parameters.AddWithValue("@Melli", txtMelli.Text + "%");
                    adp.SelectCommand.Parameters.AddWithValue("@ShTashilat", txtShTashilat.Text + "%");
